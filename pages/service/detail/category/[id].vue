      ...
      <div class="frame">
        ...
        <div class="list-product" v-if="isSkeleton">
          <div class="head">
            ...
            <span
              class="skeleton w-60 h-6 bg-gray-400 animate-pulse rounded"
            ></span>
          </div>
              ...
              <div class="card bg-base-100 shadow-xl" rel="preload">
                ...
                <div class="card-body">
                  <div class="card-title">
                    <span
                      class="skeleton min-w-full h-[20px] bg-gray-400 animate-pulse rounded"
                    ></span>
  ...
  methods: {
    ...
    getCartItems() {
      if (process.client) {
        ...
        this.navbarTo =
          "/service/detail/" + location + "?table_code=" + btoa(tableCode);
        if (cartItems) {
    ...
    toDetail(id) {
      this.$router.push("/service/detail/category/" + id);
    },
    closeModalCategory() {
