<template>
  <div class="navbar flex justify-between z-50">
    <div class="back">
      <div class="ml-20" v-if="isIndexRoute || isCheckoutRoute || isReceipt"></div>
      <div class="ml-0" v-if="isQris"></div>
      <nuxt-link
        v-if="!isIndexOrHomeRoute && !isBackOfficeRoute && !isCheckoutRoute && !isReceipt"
        :to="to"
        class="text-xl ml-3"
      >
        <svg
    ...
    <div class="profile" >
      ...
      <button class="btn" @click="goToBackOffice" v-if="isIndexRoute" style="border: none;"> 
